...
class LeftMenu extends React.Component {
  ...
  componentDidMount() {
    ...
    if (!this.props.network.isConnected) {
      this.props.network.initCypherLinkWallet(
        () => {
          this.props.mountedActions && this.props.mountedActions();
        },
        () => {
          // if a user do not login CypherLink wallet, we should do something
    ...
    // we shoule listen CypherLink to reload the webpage to get new account info
    this.props.network.listenCypherLink();
  }
        ...
        <div className="header-container">
          <div className="menu-scroll-frame">
            <div className="menu-scroll">
              <h6 className="header-logo">CYPHER DAPP Logo</h6>
