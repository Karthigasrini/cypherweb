...
export const toBigNumber = cypherWeb.toBigNumber;

// export const BigNumber = cypherWeb.BigNumber;
export const BigNumber = bigNumber;

export const toDecimal = cypherWeb.toDecimal;

export const getCypBalance = address => {
  return cypherWeb.cyp.getBalance(address);
};
...
export const fromHex = hexString => {
  return cypherWeb.address.fromHex(hexString.replace('/^0x/', '1c'));
};

export const addressToHex = addr => {
  return cypherWeb.address.toHex(addr);
};

export const isAddress = address => {
  return cypherWeb.isAddress(address);
};
...
export const copyToClipboard = (e, disBottom = '5px', p = false) => {
  ...
  if (cypherWeb.BigNumber.isBigNumber(value)) {
