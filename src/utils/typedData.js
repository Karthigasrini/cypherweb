...
function getAddress(address) {
    return CypherWeb.address.toHex(address).replace(ADDRESS_PREFIX_REGEX, '0x');
};
function getCypherAddress(address) {
    return CypherWeb.address.toHex(address);
};
...
const domainChecks = {
    ...
    verifyingContract: function (value) {
        try {
            return getCypherAddress(value).toLowerCase();
        }
        catch (error) { }
