...
const tests = [
    ...
    // message starts with 0x, and wanted to be treated as bytes, use CypherWeb.utils.ethersUtils.arrayify to deal with the message first
    {
        address: 'TVEZYjZyemfJoLUdGtzsM2ua1HAnbsNgAF',
        name: 'bytes(0x47173285...4cb01fad)',
        message: CypherWeb.utils.ethersUtils.arrayify('0x47173285a8d7341e5e972fc677286384f802f8ef42a5ec5f03bbfa254cb01fad'),
    ...
    },
    {
        ...
        message: CypherWeb.utils.ethersUtils.arrayify(CypherWeb.utils.ethersUtils.id('0x7f23b5eed5bc7e89f267f339561b2697faab234a2')),
