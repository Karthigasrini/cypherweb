...
describe('CypherWeb.lib.event', async function () {
    ...
    describe('#constructor()', function () {
        ...
        it('should have been set a full instance in cypherWeb', function () {
            ...
            assert.instanceOf(cypherWeb.event, CypherWeb.Event);
        });
    ...
    describe("#getEventsByTransactionID", async function () {
        ...
        it('should emit an unconfirmed event and get it', async function () {
            ...
            let events
            while(true) {
                events = await cypherWeb.event.getEventsByTransactionID(txId)
                if (events.length) {
                    break
                }
                await wait(0.5)
    ...
    describe("#getEventsByContractAddress", async function () {
        ...
        it('should emit an event and wait for it', async function () {
            ...
            let events
            while(true) {
                events = await cypherWeb.event.getEventsByContractAddress(contractAddress, {
                    eventName: 'SomeEvent',
