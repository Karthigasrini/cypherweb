...
describe('CypherWeb.lib.providers', async function () {


    describe('#constructor()', function () {

        it('should create a full instance', function () {
            let provider = new CypherWeb.providers.HttpProvider(FULL_NODE_API);
            assert.instanceOf(provider, CypherWeb.providers.HttpProvider);

            provider = new CypherWeb.providers.HttpProvider
            ('www.exaple.com');
            assert.instanceOf(provider, CypherWeb.providers.HttpProvider);
        });
        ...
        it('should throw if the host is not valid', function () {
            ...
            assert.throws(() => new CypherWeb.providers.HttpProvider(
                '$' + FULL_NODE_API
    ...
    describe('#setStatusPage()', function () {
        ...
        it('should set a status page', function () {
            const provider = new CypherWeb.providers.HttpProvider(FULL_NODE_API);
    ...
    describe('#isConnected()', function () {
        ...
        it('should return false if the url is not one of the expected provider', async function () {
            const provider = new CypherWeb.providers.HttpProvider('https://google.com');
